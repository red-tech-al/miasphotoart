...
export default function ShopItem() {
  ...
  // this value will be retrieved from the db
            ...
            <div className={styles.openProductRightContainer}>
              <div className={styles.openProductTitleContainer}>
                ...
                <text className={styles.openProductSubtitle}>{
                  (size === bestSellers[0].size[0].value) ? `${(quantity == 0) ? "€130" : "€" + (130 * quantity)} (VAT Incl., Shipping Costs Excl.)` : (size === bestSellers[0].size[1].value) ? `${(quantity == 0) ? "€370" : "€" + (370 * quantity)} (VAT Incl., Shipping Costs Excl.)` : (size === "Size") && `Starting From ${bestSellers[0].basePrice}`
                }
                </text>
